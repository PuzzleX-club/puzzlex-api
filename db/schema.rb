...
ActiveRecord::Schema[7.1].define(version: 2026_01_01_000000) do
  ...
  create_table "accounts_user_favorite_items", force: :cascade do |t|
  ...
  create_table "accounts_user_messages", force: :cascade do |t|
    t.bigint "user_id", null: false
  ...
  create_table "accounts_user_preferences", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "project", default: "default", null: false, comment: "project key for multi-project support"
  ...
  create_table "catalog_item_translations", force: :cascade do |t|
  ...
  create_table "catalog_items", primary_key: "item_id", id: :serial, force: :cascade do |t|
    t.string "icon"
  ...
  create_table "catalog_recipe_materials", force: :cascade do |t|
  ...
  create_table "catalog_recipe_products", force: :cascade do |t|
    t.integer "recipe_id", null: false
    t.integer "item_id", null: false
    t.integer "quantity", default: 1, null: false
  ...
  create_table "catalog_recipe_translations", force: :cascade do |t|
    t.integer "recipe_id", null: false
    t.string "locale", limit: 5, null: false
    t.string "name", null: false
    t.text "description"
  ...
  create_table "catalog_recipes", primary_key: "recipe_id", id: :serial, force: :cascade do |t|
    t.string "icon"
  ...
  create_table "item_indexer_attributes", force: :cascade do |t|
  ...
  create_table "item_indexer_instance_balances", id: { type: :string, comment: "{tokenId}-{address}" }, force: :cascade do |t|
  ...
  create_table "item_indexer_instances", id: { type: :string, comment: "tokenId (完整结构化ID)" }, force: :cascade do |t|
  ...
  create_table "item_indexer_items", id: { type: :string, comment: "itemId (从tokenId提取)" }, force: :cascade do |t|
    t.decimal "total_supply", precision: 78, default: "0", null: false, comment: "current total supply"
    t.decimal "minted_amount", precision: 78, default: "0", null: false, comment: "cumulative minted total"
    t.decimal "burned_amount", precision: 78, default: "0", null: false, comment: "cumulative burned total"
    t.bigint "last_updated", null: false, comment: "last updated timestamp"
  ...
  create_table "item_indexer_metadata", primary_key: "instance_id", id: { type: :string, comment: "tokenId" }, force: :cascade do |t|
  ...
  create_table "item_indexer_players", id: { type: :string, comment: "hex address (lowercase)" }, force: :cascade do |t|
    t.string "address", null: false
  end

  create_table "item_indexer_transactions", id: { type: :string, comment: "{txHash}-{logIndex}-{sequenceNum}" }, force: :cascade do |t|
    t.string "item", null: false, comment: "associated itemId"
    t.string "instance", null: false, comment: "associated tokenId"
  ...
  create_table "merkle_tree_nodes", force: :cascade do |t|
  ...
  create_table "merkle_tree_roots", force: :cascade do |t|
  ...
  create_table "onchain_event_listener_statuses", force: :cascade do |t|
  ...
  create_table "onchain_event_retry_ranges", force: :cascade do |t|
  ...
  create_table "onchain_event_subscriptions", force: :cascade do |t|
  ...
  create_table "onchain_log_consumptions", force: :cascade do |t|
  ...
  create_table "onchain_raw_logs", force: :cascade do |t|
    t.string "address", null: false
    t.string "event_name"
  ...
  create_table "trading_counter_events", force: :cascade do |t|
  ...
  create_table "trading_klines", force: :cascade do |t|
  ...
  create_table "trading_market_fill_events", force: :cascade do |t|
  ...
  create_table "trading_market_intraday_stats", primary_key: "market_id", force: :cascade do |t|
  ...
  create_table "trading_market_summaries", force: :cascade do |t|
  ...
  create_table "trading_order_events", force: :cascade do |t|
    t.string "event_name", null: false
    t.string "order_hash"
    t.string "offerer"
    t.string "zone"
  ...
  create_table "trading_order_fills", force: :cascade do |t|
  ...
  create_table "trading_order_items", force: :cascade do |t|
    t.bigint "order_id", null: false
  ...
  create_table "trading_order_matching_logs", force: :cascade do |t|
  ...
  create_table "trading_order_status_backups", force: :cascade do |t|
  ...
  create_table "trading_order_status_logs", force: :cascade do |t|
    t.bigint "order_id", null: false
  ...
  create_table "trading_player_balance_statuses", force: :cascade do |t|
  ...
  create_table "trading_spread_allocations", force: :cascade do |t|
    t.bigint "order_fill_id", null: false
    t.string "transaction_hash", null: false
    t.integer "log_index", null: false
    t.string "market_id", null: false
  ...
  create_table "trading_unmatched_order_events", force: :cascade do |t|
    t.string "order_hash"
    t.string "event_name"
    t.string "transaction_hash"
    t.integer "log_index"
